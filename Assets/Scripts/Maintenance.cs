...
public class Maintenance {
    ...
    public bool ShowEvent()
    {
        ...
        Event eventDesc = events.getEvent();
        ...
        my_text.text = eventDesc.Event_description;
    ...
    public void updateStats()
    {
        ...
        curPlayer.Environmental_neglect += chosenOption.Environmental_Harm;
        curPlayer.Public_neglect += chosenOption.Relation_Harm;
